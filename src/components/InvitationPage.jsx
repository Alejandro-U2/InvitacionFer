              ...
              <div className="mt-12 md:mt-16 text-center px-2">
                ...
                <p className="text-gray-600 text-sm md:text-base lg:text-lg leading-relaxed mb-6">
                  {modalOpen === 'musica' 
                    ...
                    : modalOpen === 'regalos'
                    ? ' Tu asistencia es nuestro mayor tesoro. Si deseas hacernos un regalo adicional, preferimos efectivo. Encontrarás un cofre en la entrada del evento para depositar tu sobre con cariño.'
